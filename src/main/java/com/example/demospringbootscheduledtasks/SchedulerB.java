...
public class SchedulerB {
    private final int MAX_TASK_RUNNING = 5;
    private final int AMOUNT_TASKS_TO_RUN = 20;
    ...
    public void run(){
        System.out.println("SchedulerB started...");
        ...
        System.out.println("SchedulerB finished!");
    }
}
